...
public interface HouseRepository extends JpaRepository<House, Integer>{
	...
	public Page<House> findByNameLikeOrAddressLikeOrderByCreatedAtDesc(String nameLeyword, String addressKeyword, Pageable pageable);
	public Page<House> findByNameLikeOrAddressLikeOrderByPriceAsc(String nameLeyword, String addressKeyword, Pageable pageable);
